...
public class UnleashAssignmentsQuery: GraphQLQuery {
  ...
  public struct Data: PocketGraph.SelectionSet {
    ...
    public struct Assignments: PocketGraph.SelectionSet {
      ...
      public static var __parentType: ParentType { PocketGraph.Objects.UnleashAssignmentList }
      public static var __selections: [Selection] { [
      ...
      public struct Assignment: PocketGraph.SelectionSet {
        ...
        public static var __parentType: ParentType { PocketGraph.Objects.UnleashAssignment }
        public static var __selections: [Selection] { [
